...
namespace openset
{
    namespace query
    {
        ...
        public:
            ...
            static int getMatching(LineParts& conditions, int index);

            // python uses [] and : in a few ways, this to see if this is an arrray/string slice
            static bool isSplice(LineParts& conditions, int index);
            ...
            LineParts tokenizeBlockForLogic(LineParts& parts, int searchFrom, bool isConditional, bool isFunction);
        ...
        public:
            ...
            bool compileQuery(
                ...
                Columns* columnsPtr,
                Macro_s& macros,
                ParamVars* templateVars = nullptr);
