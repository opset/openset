...
namespace openset::errors 
{
	...
	enum class errorCode_e : int32_t
	{
		...
		not_found_schema_column,
		syntax_groupby,
		syntax_column_dereference,
		syntax_in_clause,
		syntax_missing_subscript,
		syntax_missing_quotes_on_column,
		record_param_must_be_in_group,
		column_not_in_table,
		column_already_referenced,
...
namespace openset::errors 
{
	...
	static const std::unordered_map<errorCode_e, std::string> errorStrings = {
		...
		{ errorCode_e::not_found_schema_column, "not_found_schema_column" },
		...
		{ errorCode_e::syntax_missing_quotes_on_column, "syntax_missing_quotes_on_column" },
		...
		{ errorCode_e::column_not_in_table, "column_not_in_schema" },
		{ errorCode_e::missing_function_definition, "missing_function_definition" },
		{ errorCode_e::sdk_param_count, "sdk_param_count"},
		{ errorCode_e::column_already_referenced, "column_already_referenced" },
