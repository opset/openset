		...
		static const unordered_map<string, marshals_e> marshals =
			{
					...
					{"round_second", marshals_e::marshal_round_second},
					{"get_minute", marshals_e::marshal_get_minute},
					{"round_minute", marshals_e::marshal_round_minute},
					{"get_hour", marshals_e::marshal_get_hour},
					{"round_hour", marshals_e::marshal_round_hour},
					{"round_day", marshals_e::marshal_round_day},
					...
					{"round_week", marshals_e::marshal_round_week},
					{"round_month", marshals_e::marshal_round_month},
					{"get_month", marshals_e::marshal_get_month},
					{"get_quarter", marshals_e::marshal_get_quarter},
					{"round_quarter", marshals_e::marshal_round_quarter},
					{"get_year", marshals_e::marshal_get_year},
					{"round_year", marshals_e::marshal_round_year},
